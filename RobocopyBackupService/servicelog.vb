...
Public NotInheritable Class serviceLogger
    Private Sub New()
    End Sub
    ...
    Public Shared Sub LogConfig()
        If Writer IsNot Nothing Then
            ...
            ' Produces log cleaner log line
            For Each task As Task In Config.Tasks.Values
                ' Produces task detail log line
    ...
    End Sub
    '
    Public Shared Sub LogConfignotLoad()
        If Writer IsNot Nothing Then
            Log("[Config] config file not exist, 0 task present!!!")
        End If
    End Sub
